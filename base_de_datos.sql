...
INSERT INTO postalcode (PóstalCodeNumber) VALUES 
('24006'),
('24010'),
('85495'),
('696969'),
...
INSERT INTO persontypes (Name) VALUES
('Director General'),
...
INSERT INTO person (Name, LastName1, LastName2, Email, PersonTypeId) VALUES
...
INSERT INTO office (CityId, Phone, AdressLine, AdressLine2) VALUES 
(9,34933561,'Avenida Diagonal, 38','3A escalera Derecha'),
(14,12158370,'1550 Court Place','Suite 102'),
(15,4420787720,'52 Old Broad Street','Ground Floor'),
(7,349175144,'Bulevar Indalecio Prieto, 32',''),
(16,33147234,'29 Rue Jouffroy d''abbans',''),
(1,165021947,'100 Market Street','Suite 300'),
(17,612926424,'5-11 Wentworth Avenue','Floor #2'),
(18,349258672,'Francisco Aguirre, 32','5º piso (exterior)'),
(19,81332245,'4-1 Kioicho','');

INSERT INTO office (OfficeCode, CityId, Phone, AdressLine, AdressLine2) VALUES 
('BCN-ES',9,3,'Avenida Diagonal, 38','3A escalera Derecha'),
('BOS-USA',14,1,'1550 Court Place','Suite 102'),
('LON-UK',15,4,'52 Old Broad Street','Ground Floor'),
('MAD-ES',7,3,'Bulevar Indalecio Prieto, 32',''),
('PAR-FR',16,3,'29 Rue Jouffroy d''abbans',''),
('SFC-USA',1,1,'100 Market Street','Suite 300'),
('SYD-AU',17,6,'5-11 Wentworth Avenue','Floor #2'),
('TAL-ES',18,3,'Francisco Aguirre, 32','5º piso (exterior)'),
('TOK-JP',19,8,'4-1 Kioicho','');

INSERT INTO employee (PersonId, Extention, OfficeId, ManagerCode, postalCodeId	) VALUES 
(1,'3897',16,7,1,3),
(2,'2899',12,1,3,4),
(3,'2837',13,2,5,5),
(4,'2847',15,2,1,4),
...
INSERT INTO entity ( PersonId, Phone, Fax, LineAdress, LineAdress2, PostalCodeId, EmployeeId, CreditLimit) VALUES 
(32, '5556901745', '5556901746', 'False Street 52 2 A', NULL, 1, 19, 3000),
(33, '5557410345', '5557410346', 'Wall-e Avenue', NULL, 2, 19, 6000),
(34, '5552323129', '5552323128', 'Oaks Avenue nº22', NULL, 3, 22, 12000),
(35, '55591233210', '55591233211', 'Null Street nº69', NULL, 4, 22, 600000),
(36, '34916540145', '34914851312', 'C/Leganes 15', NULL, 5, 8, 154310),
(37, '654987321', '916549872', 'C/pintor segundo', 'Getafe', 6, 11, 20000),
(38, '62456810', '919535678', 'C/sinesio delgado', 'Madrid', 7, 11, 40000),
(39, '689234750', '916428956', 'C/majadahonda', 'Boadilla', 8, 11, 32000),
(40, '675598001', '916421756', 'C/azores', 'Fuenlabrada', 9, 11, 50000),
(41, '655983045', '916689215', 'C/Lagañas', 'Fuenlabrada', 10, 11, 20000),
(42, '34916540145', '34914851312', 'C/Leganes 15', NULL, 5, 8, 154310),
(43, '34914873241', '34914871541', 'C/Virgenes 45', 'C/Princesas 2 1ºB', 11, 8, 16481);
